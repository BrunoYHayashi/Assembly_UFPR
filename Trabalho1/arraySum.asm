...
; Com 43 instruções (0 a 42), o Vetor A começará no endereço 43.
xor r0, r0
addi 7
addi 7
addi 7
...
addi 1          ; R0 = 43
xor r1, r1
add r1, r0      ; R1 = 43 (Ponteiro para Vetor A)
...
addi 6          ; R0 = 13
xor r3, r3
add r3, r0      ; R3 = 13 (Endereço do Loop)
...
soma_V:
    ...
    addi 7
    addi 3
    add r0, r1      ; R0 volta a ser Endereço de B[i]
    addi 7
    addi 3          ; R0 = R0 + 10 = Endereço de R[i]
    ...
    ; Controle de fluxo
    brzr r0, 2 ; Se acabou, pula o salto de volta
    xor r0, r0
